  ...
  <v-container fluid>
    <v-row align="center" justify="center">
      <v-col cols="11">
        ...
        <p>
          Cette application est conçue pour être une vitrine accessible des technologies mise en oeuvre au sein de l'Abes.
          Elle est à la disposition des nouveaux employées et employés de l'établissement afin qu'ils et elles puissent s'approprier plus facilement lesdites technologies.
        </p>
        <br>
