...
export default {
  name: 'SecureApi',
  data: () => ({
    urlApi: 'http://cirse1-dev.v3.abes.fr:8132/Hello_Abes_back_end/api/secured',
    urlCommande: 'http://cirse1-dev.v3.abes.fr:8132/Hello_Abes_back_end/api/secured/commande',
    resApi: '',
    loading: true,
    tabHeader:[
      {
